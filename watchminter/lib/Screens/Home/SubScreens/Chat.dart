        ...
        children: [
          ...
          Stack(
            children: [Column(
              ...
              Center(child: Text("You have no chats yet",style: TextStyle(color: AppColors.grey,fontSize: 15),),)
            ],
          )
        ],
      ),
      ...
      child: Container(
        child: Row(
          children: [
            ...
            children: [
              Text("John Doe",style: TextStyle(fontWeight: FontWeight.bold,color: AppColors.background,fontFamily: "Gotham"),),
              Text("Here is what i want to ...",style: TextStyle(color: AppColors.background,fontFamily: "Gotham"),)
            ],
            )
            ,),
            Expanded(
              ...
              child: Align(
                ...
                child: Text(
                  "12:00 PM",style: TextStyle(color: Colors.grey),
                ),
              ),
            ),
          ],
